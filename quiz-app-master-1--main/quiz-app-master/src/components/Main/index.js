...
const Main = ({ startQuiz }) => {
  ...
  <div style={{
    ...
    alignItems: "center",
    height: "100vh",
    backgroundImage: "url('https://i.postimg.cc/R0CFVPpP/picc3.jpg')",
        ...
        <Item.Group divided>
          <Item>
            ...
            <Item.Content>
              ...
              <Divider />
              <Item.Meta>
                <p>Which category catches your attention?</p>
                <Dropdown
                  fluid
                  selection
                  name="category"
                ...
                />
                <br />
                <p>How long do you want this quiz journey to be?</p>
                <Dropdown
                  fluid
                  selection
                  name="numOfQ"
                ...
                />
                <br />
                <p>What level of challenge are you up for?</p>
                <Dropdown
                  fluid
                  selection
                  name="difficulty"
